...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CompletedShift.duration'
        db.alter_column('volunteers_completedshift', 'duration', self.gf('django.db.models.fields.DecimalField')(max_digits=6, decimal_places=2))


    def backwards(self, orm):
        
        # Changing field 'CompletedShift.duration'
        db.alter_column('volunteers_completedshift', 'duration', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=6, decimal_places=2))
