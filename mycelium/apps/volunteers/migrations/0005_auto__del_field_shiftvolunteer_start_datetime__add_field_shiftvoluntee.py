...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'ShiftVolunteer.start_datetime'
        db.delete_column('volunteers_shiftvolunteer', 'start_datetime')

        # Adding field 'ShiftVolunteer.date'
        db.add_column('volunteers_shiftvolunteer', 'date', self.gf('django.db.models.fields.DateField')(default=datetime.date.today), keep_default=False)


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'ShiftVolunteer.start_datetime'
        raise RuntimeError("Cannot reverse this migration. 'ShiftVolunteer.start_datetime' and its values cannot be restored.")

        # Deleting field 'ShiftVolunteer.date'
        db.delete_column('volunteers_shiftvolunteer', 'date')
