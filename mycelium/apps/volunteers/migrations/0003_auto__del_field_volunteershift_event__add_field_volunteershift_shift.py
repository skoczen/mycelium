...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'VolunteerShift.event'
        db.delete_column('volunteers_volunteershift', 'event_id')

        # Adding field 'VolunteerShift.shift'
        db.add_column('volunteers_volunteershift', 'shift', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='Event (optional)', null=True, to=orm['volunteers.VolunteerShiftEvent']), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'VolunteerShift.event'
        db.add_column('volunteers_volunteershift', 'event', self.gf('django.db.models.fields.related.ForeignKey')(related_name='Event (optional)', null=True, to=orm['volunteers.VolunteerShiftEvent'], blank=True), keep_default=False)

        # Deleting field 'VolunteerShift.shift'
        db.delete_column('volunteers_volunteershift', 'shift_id')
    ...
    models = {
        ...
        'volunteers.volunteershift': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified_at': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'shift': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'Event (optional)'", 'null': 'True', 'to': "orm['volunteers.VolunteerShiftEvent']"}),
