...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'ScheduledShift'
        db.create_table('volunteers_scheduledshift', (
        ...
        db.send_create_signal('volunteers', ['ScheduledShift'])

        # Adding field 'CompletedShift.scheduled_shift'
        db.add_column('volunteers_completedshift', 'scheduled_shift', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['volunteers.ScheduledShift'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting model 'ScheduledShift'
        db.delete_table('volunteers_scheduledshift')

        # Deleting field 'CompletedShift.scheduled_shift'
        db.delete_column('volunteers_completedshift', 'scheduled_shift_id')
    ...
    models = {
        ...
        'volunteers.completedshift': {
            'Meta': {'ordering': "['-date']", 'object_name': 'CompletedShift'},
            'created_at': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
