...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Volunteer.status'
        db.add_column('volunteers_volunteer', 'status', self.gf('django.db.models.fields.CharField')(default=('active', 'Active'), max_length=50), keep_default=False)

        # Adding field 'Volunteer.reactivation_date'
        db.add_column('volunteers_volunteer', 'reactivation_date', self.gf('django.db.models.fields.DateField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Volunteer.status'
        db.delete_column('volunteers_volunteer', 'status')

        # Deleting field 'Volunteer.reactivation_date'
        db.delete_column('volunteers_volunteer', 'reactivation_date')
