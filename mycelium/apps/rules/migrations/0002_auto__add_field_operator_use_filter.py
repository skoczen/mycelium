...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Operator.use_filter'
        db.add_column('rules_operator', 'use_filter', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Operator.use_filter'
        db.delete_column('rules_operator', 'use_filter')
