...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'LeftSide.add_closing_paren'
        db.add_column('rules_leftside', 'add_closing_paren', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'LeftSide.add_closing_paren'
        db.delete_column('rules_leftside', 'add_closing_paren')
