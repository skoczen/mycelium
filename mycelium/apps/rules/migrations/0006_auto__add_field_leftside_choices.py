...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'LeftSide.choices'
        db.add_column('rules_leftside', 'choices', self.gf('picklefield.fields.PickledObjectField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'LeftSide.choices'
        db.delete_column('rules_leftside', 'choices')
