...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Operator.account'
        db.add_column('rules_operator', 'account', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['accounts.Account']), keep_default=False)

        # Adding field 'LeftSide.account'
        db.add_column('rules_leftside', 'account', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['accounts.Account']), keep_default=False)

        # Adding field 'RightSideType.account'
        db.add_column('rules_rightsidetype', 'account', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['accounts.Account']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Operator.account'
        db.delete_column('rules_operator', 'account_id')

        # Deleting field 'LeftSide.account'
        db.delete_column('rules_leftside', 'account_id')

        # Deleting field 'RightSideType.account'
        db.delete_column('rules_rightsidetype', 'account_id')
