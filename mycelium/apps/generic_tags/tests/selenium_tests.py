...
class TestAgainstNoData(QiConservativeSeleniumTestCase, TagTestAbstractions, PeopleTestAbstractions):
    ...
    def test_adding_multiple_tags_to_one_category(self):
        sel = self.selenium
        self.create_person_and_go_to_tag_tab()
        sel.type("css=#new_General_tag_form .new_tag_name_input","test tag 1")
        sel.click("css=#new_General_tag_form .tag_add_btn")
        ...
        sel.type("css=#new_General_tag_form .new_tag_name_input","test tag 2")
        sel.click("css=#new_General_tag_form .tag_add_btn")
        time.sleep(1)
        assert sel.is_text_present("Test Tag 2")
        assert sel.is_element_present("css=fragment[name=General_tags] .checkbox.checked:nth(1) input:checked")
        self.assertEqual("Test Tag 2",sel.get_text("css=fragment[name=General_tags] .checkbox.checked:nth(1) label name"))

        sel.type("css=#new_General_tag_form .new_tag_name_input","test tag 3")
        sel.click("css=#new_General_tag_form .tag_add_btn")
        time.sleep(1)
        assert sel.is_text_present("Test Tag 3")
        assert sel.is_element_present("css=fragment[name=General_tags] .checkbox.checked:nth(2) input:checked")
        self.assertEqual("Test Tag 3",sel.get_text("css=fragment[name=General_tags] .checkbox.checked:nth(2) label name"))
