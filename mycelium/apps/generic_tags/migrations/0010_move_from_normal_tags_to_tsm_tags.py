...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        p_ct = ContentType.objects.get(app_label="generic_tags",model="TagSetMembership")
        for pt in TaggedItem.objects.filter(content_type=p_ct):
            if pt.content_type == p_ct:
                orm.TaggedTagSetMembership.objects.create(id=pt.id, tag_id=pt.tag_id, content_object_id=pt.object_id)
