...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Spreadsheet.default_filetype'
        db.add_column('spreadsheets_spreadsheet', 'default_filetype', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Spreadsheet.default_filetype'
        db.delete_column('spreadsheets_spreadsheet', 'default_filetype')
    ...
    models = {
        ...
        'spreadsheets.spreadsheet': {
            ...
            'account': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['accounts.Account']"}),
            'created_at': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'default_filetype': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
