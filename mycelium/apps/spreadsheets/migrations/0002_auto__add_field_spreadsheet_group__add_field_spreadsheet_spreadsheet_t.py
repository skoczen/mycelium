...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Spreadsheet.group'
        db.add_column('spreadsheets_spreadsheet', 'group', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['groups.Group'], null=True, blank=True), keep_default=False)

        # Adding field 'Spreadsheet.spreadsheet_template'
        db.add_column('spreadsheets_spreadsheet', 'spreadsheet_template', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Spreadsheet.group'
        db.delete_column('spreadsheets_spreadsheet', 'group_id')

        # Deleting field 'Spreadsheet.spreadsheet_template'
        db.delete_column('spreadsheets_spreadsheet', 'spreadsheet_template')
    ...
    models = {
        ...
        'spreadsheets.spreadsheet': {
            ...
            'name': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'qi_simple_searchable_search_field': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'spreadsheet_template': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'})
        },
