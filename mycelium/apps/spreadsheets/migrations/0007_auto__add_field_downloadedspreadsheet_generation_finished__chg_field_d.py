...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'DownloadedSpreadsheet.generation_finished'
        db.add_column('spreadsheets_downloadedspreadsheet', 'generation_finished', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Changing field 'DownloadedSpreadsheet.downloaded_file'
        db.alter_column('spreadsheets_downloadedspreadsheet', 'downloaded_file', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True))


    def backwards(self, orm):
        
        # Deleting field 'DownloadedSpreadsheet.generation_finished'
        db.delete_column('spreadsheets_downloadedspreadsheet', 'generation_finished')

        # Changing field 'DownloadedSpreadsheet.downloaded_file'
        db.alter_column('spreadsheets_downloadedspreadsheet', 'downloaded_file', self.gf('django.db.models.fields.files.FileField')(default=None, max_length=100))
    ...
    models = {
        'accounts.account': {
            ...
            'signup_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 7, 24, 5, 32, 38, 738969)', 'null': 'True'}),
        ...
        'spreadsheets.downloadedspreadsheet': {
            ...
            'account': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['accounts.Account']"}),
            'created_at': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'downloaded_file': ('django.db.models.fields.files.FileField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'file_type': ('django.db.models.fields.CharField', [], {'default': "'CSV'", 'max_length': '20'}),
            'generation_finished': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified_at': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
