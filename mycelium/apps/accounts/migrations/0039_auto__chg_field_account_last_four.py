...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Account.last_four'
        db.alter_column('accounts_account', 'last_four', self.gf('django.db.models.fields.CharField')(max_length=4, null=True))


    def backwards(self, orm):
        
        # Changing field 'Account.last_four'
        db.alter_column('accounts_account', 'last_four', self.gf('django.db.models.fields.DateTimeField')(null=True))
    ...
    models = {
        ...
        'accounts.account': {
            ...
            'signup_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 9, 15, 3, 0, 30, 217634)', 'null': 'True'}),
