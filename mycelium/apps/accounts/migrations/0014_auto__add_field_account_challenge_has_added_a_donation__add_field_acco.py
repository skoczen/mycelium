...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Account.challenge_has_added_a_donation'
        db.add_column('accounts_account', 'challenge_has_added_a_donation', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Account.challenge_has_logged_volunteer_hours'
        db.add_column('accounts_account', 'challenge_has_logged_volunteer_hours', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Account.challenge_has_added_a_donation'
        db.delete_column('accounts_account', 'challenge_has_added_a_donation')

        # Deleting field 'Account.challenge_has_logged_volunteer_hours'
        db.delete_column('accounts_account', 'challenge_has_logged_volunteer_hours')
