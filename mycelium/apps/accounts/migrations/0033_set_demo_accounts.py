...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        DEMO_SUBDOMAINS = ["demo", "otltraining","test12", "test2", "penisbrigade", "test1", "test", "test1234", "testgeeksunited", "teststeven", "tour"]
        for sub in DEMO_SUBDOMAINS:
    ...
    models = {
        ...
        'accounts.account': {
            ...
            'signup_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 7, 19, 22, 25, 40, 112165)', 'null': 'True'}),
