...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        from accounts import FEATURE_ACCESS_STATII
        "Write your forwards methods here."
        ALPHA_SUBDOMAINS = ["test12", "test2", "test1", "test", "test1234", "teststeven", "goodcloud", "smallnonprofitresourcecenter"]
        for sub in ALPHA_SUBDOMAINS:
            a = orm.Account.objects.get(subdomain=sub)
            a.feature_access_level = FEATURE_ACCESS_STATII[2][0]
            a.save()

        BETA_SUBDOMAINS = ["goodcloud",]
        for sub in BETA_SUBDOMAINS:
            a = orm.Account.objects.get(subdomain=sub)
            a.feature_access_level = FEATURE_ACCESS_STATII[1][0]
            a.save()
    ...
    models = {
        ...
        'accounts.account': {
            ...
            'signup_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 8, 16, 21, 50, 47, 460291)', 'null': 'True'}),
