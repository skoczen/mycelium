...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        [o.save() for o in orm.AccessLevel.objects.all()]
        [o.save() for o in orm.Account.objects.all()]
        [o.save() for o in orm.Plan.objects.all()]
        [o.save() for o in orm.UserAccount.objects.all()]
