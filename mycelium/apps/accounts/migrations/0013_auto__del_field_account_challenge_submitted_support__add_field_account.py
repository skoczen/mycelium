...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Account.challenge_has_submitted_support'
        db.add_column('accounts_account', 'challenge_has_submitted_support', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Account.challenge_has_submitted_support'
        db.delete_column('accounts_account', 'challenge_has_submitted_support')
