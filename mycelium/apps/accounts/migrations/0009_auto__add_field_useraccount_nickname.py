...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserAccount.nickname'
        db.add_column('accounts_useraccount', 'nickname', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UserAccount.nickname'
        db.delete_column('accounts_useraccount', 'nickname')
