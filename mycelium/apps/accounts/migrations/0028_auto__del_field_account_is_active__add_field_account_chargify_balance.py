...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('accounts_account', 'is_active')

        # Adding field 'Account.chargify_balance'
        db.add_column('accounts_account', 'chargify_balance', self.gf('django.db.models.fields.FloatField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Account.is_active'
        db.add_column('accounts_account', 'is_active', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)
    ...
    models = {
        ...
        'accounts.account': {
            ...
            'chargify_balance': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
            ...
            'signup_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 7, 18, 21, 37, 15, 978124)', 'null': 'True'}),
