...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'Account', fields ['subdomain']
        db.create_unique('accounts_account', ['subdomain'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'Account', fields ['subdomain']
        db.delete_unique('accounts_account', ['subdomain'])
    ...
    models = {
        ...
        'accounts.account': {
            ...
            'subdomain': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '255'})
        },
        'accounts.plan': {
