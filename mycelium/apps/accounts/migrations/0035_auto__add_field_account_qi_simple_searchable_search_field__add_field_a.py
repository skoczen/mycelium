...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserAccount.timezone'
        db.add_column('accounts_useraccount', 'timezone', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)


    def backwards(self, orm):

        # Deleting field 'UserAccount.timezone'
        db.delete_column('accounts_useraccount', 'timezone')
    ...
    models = {
        ...
        'accounts.account': {
            ...
            'signup_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 8, 22, 22, 18, 44, 863993)', 'null': 'True'}),
