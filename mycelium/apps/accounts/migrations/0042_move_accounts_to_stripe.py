...
from accounts import FREE_PLAN_NAME
...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        FREE_FOR_NOW_SUBDOMAINS = ["cli", "stgerardhouse"]

        for a in Account.objects.all():
            print "making a subscription for %s..." % a.name,
            a.create_stripe_subscription()

            # Special cases
            if a.subdomain in FREE_FOR_NOW_SUBDOMAINS:
                c = a.stripe_customer
                c.update_subscription(plan=FREE_PLAN_NAME,trial_end=a.free_trial_ends_date)      
                print " (marked as free) ",
            print " done."
    ...
    models = {
        ...
        'accounts.account': {
            ...
            'signup_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 9, 23, 7, 29, 59, 12834)', 'null': 'True'}),
