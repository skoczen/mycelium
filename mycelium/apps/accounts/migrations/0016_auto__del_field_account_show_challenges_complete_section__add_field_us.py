...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Account.show_challenges_complete_section'
        db.delete_column('accounts_account', 'show_challenges_complete_section')

        # Adding field 'UserAccount.show_challenges_complete_section'
        db.add_column('accounts_useraccount', 'show_challenges_complete_section', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Account.show_challenges_complete_section'
        db.add_column('accounts_account', 'show_challenges_complete_section', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)

        # Deleting field 'UserAccount.show_challenges_complete_section'
        db.delete_column('accounts_useraccount', 'show_challenges_complete_section')
