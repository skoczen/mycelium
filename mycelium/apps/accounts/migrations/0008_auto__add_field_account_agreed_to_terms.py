...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Account.agreed_to_terms'
        db.add_column('accounts_account', 'agreed_to_terms', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Account.agreed_to_terms'
        db.delete_column('accounts_account', 'agreed_to_terms')
