...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Account.last_stripe_update'
        db.add_column('accounts_account', 'last_stripe_update', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Account.last_stripe_update'
        db.delete_column('accounts_account', 'last_stripe_update')
    ...
    models = {
        ...
        'accounts.account': {
            ...
            'signup_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 9, 23, 4, 4, 50, 838371)', 'null': 'True'}),
