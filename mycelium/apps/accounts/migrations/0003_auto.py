...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding index on 'Account', fields ['subdomain']
        db.create_index('accounts_account', ['subdomain'])


    def backwards(self, orm):
        
        # Removing index on 'Account', fields ['subdomain']
        db.delete_index('accounts_account', ['subdomain'])
