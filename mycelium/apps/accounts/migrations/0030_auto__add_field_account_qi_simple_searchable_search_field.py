...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Account.qi_simple_searchable_search_field'
        db.add_column('accounts_account', 'qi_simple_searchable_search_field', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Account.qi_simple_searchable_search_field'
        db.delete_column('accounts_account', 'qi_simple_searchable_search_field')
    ...
    models = {
        ...
        'accounts.account': {
            ...
            'signup_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 7, 19, 0, 38, 22, 378197)', 'null': 'True'}),
