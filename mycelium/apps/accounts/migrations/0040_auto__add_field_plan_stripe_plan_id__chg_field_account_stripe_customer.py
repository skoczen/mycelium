...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Plan.stripe_plan_id'
        db.add_column('accounts_plan', 'stripe_plan_id', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True), keep_default=False)

        # Changing field 'Account.stripe_customer_id'
        db.alter_column('accounts_account', 'stripe_customer_id', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))


    def backwards(self, orm):
        
        # Deleting field 'Plan.stripe_plan_id'
        db.delete_column('accounts_plan', 'stripe_plan_id')

        # Changing field 'Account.stripe_customer_id'
        db.alter_column('accounts_account', 'stripe_customer_id', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))
    ...
    models = {
        ...
        'accounts.account': {
            ...
            'signup_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 9, 18, 20, 46, 38, 500557)', 'null': 'True'}),
