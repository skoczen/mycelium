...
class TestAgainstGeneratedData(SeleniumTestCase):
    ...
    def test_adding_people_to_an_org_shows_on_their_people_page(self):
        ...
        self.assertEqual("Chief Pooh-bah Tester", sel.get_text("css=employee:nth(0) .title"))
        self.assertEqual("503 247-8451", sel.get_text("css=employee:nth(0) .phone"))
        self.assertEqual("joysmith@myneworg.org", sel.get_text("css=employee:nth(0) .email"))
