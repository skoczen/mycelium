...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Person.birth_day'
        db.add_column('people_person', 'birth_day', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Person.birth_day'
        db.delete_column('people_person', 'birth_day')
