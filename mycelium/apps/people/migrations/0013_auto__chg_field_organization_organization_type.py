...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Organization.organization_type'
        db.alter_column('people_organization', 'organization_type_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['people.OrganizationType'], null=True))


    def backwards(self, orm):
        
        # Changing field 'Organization.organization_type'
        db.alter_column('people_organization', 'organization_type_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['people.OrganizationType']))
