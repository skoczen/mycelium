...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('people_emailaddress', 'email', self.gf('django.db.models.fields.CharField')(max_length=255))


    def backwards(self, orm):
        
        # Changing field 'EmailAddress.email'
        db.alter_column('people_emailaddress', 'email', self.gf('django.db.models.fields.EmailField')(max_length=255))
