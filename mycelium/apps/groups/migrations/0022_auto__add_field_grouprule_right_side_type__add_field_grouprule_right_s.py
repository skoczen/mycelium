...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'GroupRule.right_side_type'
        db.add_column('groups_grouprule', 'right_side_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['rules.RightSideType'], null=True, blank=True), keep_default=False)

        # Adding field 'GroupRule.right_side_value'
        db.add_column('groups_grouprule', 'right_side_value', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'GroupRule.right_side_type'
        db.delete_column('groups_grouprule', 'right_side_type_id')

        # Deleting field 'GroupRule.right_side_value'
        db.delete_column('groups_grouprule', 'right_side_value')
