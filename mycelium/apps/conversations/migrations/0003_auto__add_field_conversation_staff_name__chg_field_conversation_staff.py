...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Conversation.staff_name'
        db.add_column('conversations_conversation', 'staff_name', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)

        # Changing field 'Conversation.staff'
        db.alter_column('conversations_conversation', 'staff_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['accounts.UserAccount'], null=True))


    def backwards(self, orm):
        
        # Deleting field 'Conversation.staff_name'
        db.delete_column('conversations_conversation', 'staff_name')

        # User chose to not deal with backwards NULL issues for 'Conversation.staff'
        raise RuntimeError("Cannot reverse this migration. 'Conversation.staff' and its values cannot be restored.")
    ...
    models = {
        ...
        'accounts.account': {
            ...
            'signup_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 10, 6, 5, 0, 58, 931261)', 'null': 'True'}),
        ...
        'conversations.conversation': {
            ...
            'created_at': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 10, 6, 5, 0, 59, 99346)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified_at': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
