...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Conversation.staff'
        db.add_column('conversations_conversation', 'staff', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['accounts.UserAccount']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Conversation.staff'
        db.delete_column('conversations_conversation', 'staff_id')
    ...
    models = {
        ...
        'conversations.conversation': {
            'Meta': {'ordering': "('-date',)", 'object_name': 'Conversation'},
            'account': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['accounts.Account']"}),
            'body': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'conversation_type': ('django.db.models.fields.CharField', [], {'default': "'email'", 'max_length': '50'}),
            'created_at': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 6, 28, 16, 58, 26, 272936)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified_at': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
