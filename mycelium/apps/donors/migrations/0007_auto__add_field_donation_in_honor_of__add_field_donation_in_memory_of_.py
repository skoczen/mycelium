...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Donation.in_honor_of'
        db.add_column('donors_donation', 'in_honor_of', self.gf('django.db.models.fields.BooleanField')(default=False, db_index=True), keep_default=False)

        # Adding field 'Donation.in_memory_of'
        db.add_column('donors_donation', 'in_memory_of', self.gf('django.db.models.fields.BooleanField')(default=False, db_index=True), keep_default=False)

        # Adding field 'Donation.honorarium_name'
        db.add_column('donors_donation', 'honorarium_name', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Donation.in_honor_of'
        db.delete_column('donors_donation', 'in_honor_of')

        # Deleting field 'Donation.in_memory_of'
        db.delete_column('donors_donation', 'in_memory_of')

        # Deleting field 'Donation.honorarium_name'
        db.delete_column('donors_donation', 'honorarium_name')
    ...
    models = {
        'accounts.account': {
            ...
            'signup_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 9, 30, 4, 51, 31, 241662)', 'null': 'True'}),
