...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('donors_donation', 'type', self.gf('django.db.models.fields.CharField')(default='CASH', max_length=10, db_index=True), keep_default=False)

        # Adding field 'Donation.notes'
        db.add_column('donors_donation', 'notes', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Donation.type'
        db.delete_column('donors_donation', 'type')

        # Deleting field 'Donation.notes'
        db.delete_column('donors_donation', 'notes')
    ...
    models = {
        'accounts.account': {
            ...
            'signup_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 9, 28, 3, 49, 25, 855377)', 'null': 'True'}),
