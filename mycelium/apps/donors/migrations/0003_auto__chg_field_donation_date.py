...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('donors_donation', 'date', self.gf('django.db.models.fields.DateField')())


    def backwards(self, orm):
        
        # Changing field 'Donation.date'
        db.alter_column('donors_donation', 'date', self.gf('django.db.models.fields.DateTimeField')())
