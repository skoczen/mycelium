...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Action.staff_name'
        db.add_column('activities_action', 'staff_name', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)

        # Changing field 'Action.staff'
        db.alter_column('activities_action', 'staff_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['accounts.UserAccount'], null=True))


    def backwards(self, orm):
        
        # Deleting field 'Action.staff_name'
        db.delete_column('activities_action', 'staff_name')

        # User chose to not deal with backwards NULL issues for 'Action.staff'
        raise RuntimeError("Cannot reverse this migration. 'Action.staff' and its values cannot be restored.")
    ...
    models = {
        ...
        'accounts.account': {
            ...
            'signup_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 10, 6, 5, 1, 33, 18084)', 'null': 'True'}),
        ...
        'activities.action': {
            ...
            'created_at': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 10, 6, 5, 1, 33, 314797)'}),
            ...
            'staff': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['accounts.UserAccount']", 'null': 'True', 'blank': 'True'}),
            'staff_name': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'})
        },
        'activities.activity': {
        ...
        'conversations.conversation': {
            ...
            'created_at': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 10, 6, 5, 1, 33, 184204)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified_at': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
