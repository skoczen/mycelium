...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Action.spreadsheet'
        db.add_column('activities_action', 'spreadsheet', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['spreadsheets.Spreadsheet'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Action.spreadsheet'
        db.delete_column('activities_action', 'spreadsheet_id')
    ...
    models = {
        ...
        'accounts.account': {
            ...
            'signup_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 12, 15, 6, 57, 21, 483747)', 'null': 'True'}),
        ...
        'activities.action': {
            ...
            'created_at': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 12, 15, 6, 57, 21, 851518)'}),
        ...
        'conversations.conversation': {
            ...
            'created_at': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 12, 15, 6, 57, 21, 708892)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified_at': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
