...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'DataImport.source_filename'
        db.add_column('data_import_dataimport', 'source_filename', self.gf('django.db.models.fields.TextField')(default=None), keep_default=False)

        # Changing field 'DataImport.import_type'
        db.alter_column('data_import_dataimport', 'import_type', self.gf('django.db.models.fields.CharField')(max_length=50))
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'DataImport.source_filename'
        db.delete_column('data_import_dataimport', 'source_filename')

        # Changing field 'DataImport.import_type'
        db.alter_column('data_import_dataimport', 'import_type', self.gf('django.db.models.fields.IntegerField')())
