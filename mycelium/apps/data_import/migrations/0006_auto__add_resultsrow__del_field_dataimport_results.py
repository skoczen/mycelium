...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'ResultsRow'
        db.create_table('data_import_resultsrow', (
            ...
            ('successfully_imported', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('new_record_created', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('targets', self.gf('picklefield.fields.PickledObjectField')(null=True, blank=True)),
            ('primary_target_id', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
        ))
        db.send_create_signal('data_import', ['ResultsRow'])

        # Deleting field 'DataImport.results'
        db.delete_column('data_import_dataimport', 'results')


    def backwards(self, orm):
        
        # Deleting model 'ResultsRow'
        db.delete_table('data_import_resultsrow')

        # Adding field 'DataImport.results'
        db.add_column('data_import_dataimport', 'results', self.gf('picklefield.fields.PickledObjectField')(null=True, blank=True), keep_default=False)
