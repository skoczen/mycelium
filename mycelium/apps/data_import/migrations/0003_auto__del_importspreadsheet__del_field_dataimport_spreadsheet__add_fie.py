...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting model 'ImportSpreadsheet'
        db.delete_table('data_import_importspreadsheet')

        # Deleting field 'DataImport.spreadsheet'
        db.delete_column('data_import_dataimport', 'spreadsheet_id')

        # Adding field 'DataImport.source_file'
        db.add_column('data_import_dataimport', 'source_file', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True), keep_default=False)

        # Adding field 'DataImport.source_type'
        db.add_column('data_import_dataimport', 'source_type', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'DataImport.fields'
        db.add_column('data_import_dataimport', 'fields', self.gf('picklefield.fields.PickledObjectField')(null=True, blank=True), keep_default=False)

        # Adding field 'DataImport.has_header'
        db.add_column('data_import_dataimport', 'has_header', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Adding model 'ImportSpreadsheet'
        db.create_table('data_import_importspreadsheet', (
            ...
            ('has_header', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('columns', self.gf('picklefield.fields.PickledObjectField')(null=True, blank=True)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal('data_import', ['ImportSpreadsheet'])

        # User chose to not deal with backwards NULL issues for 'DataImport.spreadsheet'
        raise RuntimeError("Cannot reverse this migration. 'DataImport.spreadsheet' and its values cannot be restored.")

        # Deleting field 'DataImport.source_file'
        db.delete_column('data_import_dataimport', 'source_file')

        # Deleting field 'DataImport.source_type'
        db.delete_column('data_import_dataimport', 'source_type')

        # Deleting field 'DataImport.fields'
        db.delete_column('data_import_dataimport', 'fields')

        # Deleting field 'DataImport.has_header'
        db.delete_column('data_import_dataimport', 'has_header')
    ...
    models = {
        ...
        'data_import.dataimport': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'import_type': ('django.db.models.fields.IntegerField', [], {}),
