...
function intelligently_show_hide_comma() {
    ...
    if ( ($("#container_id_birth_month .view_field",target).html() != "Unknown" && $("#container_id_birth_month .view_field",target).html() != "") || $("#container_id_birth_year .view_field").html() != "" || $("#container_id_birth_date .view_field").html() != "" ) {
		$(".birthday").show();
    } else {
    	$(".birthday").hide();
    }
