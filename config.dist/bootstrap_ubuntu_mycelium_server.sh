...
mv /etc/init/mycelium.conf /etc/init/mycelium.conf.bak
cp /var/www/mycelium.git/config.dist/celery-upstart /etc/init/celeryd.conf
cp  /var/www/mycelium.git/config.dist/gunicorn-upstart /etc/init/mycelium.conf
