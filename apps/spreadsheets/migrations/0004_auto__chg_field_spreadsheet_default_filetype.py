...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Spreadsheet.default_filetype'
        db.alter_column('spreadsheets_spreadsheet', 'default_filetype', self.gf('django.db.models.fields.CharField')(max_length=255))


    def backwards(self, orm):
        
        # Changing field 'Spreadsheet.default_filetype'
        db.alter_column('spreadsheets_spreadsheet', 'default_filetype', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))
    ...
    models = {
        ...
        'spreadsheets.spreadsheet': {
            ...
            'account': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['accounts.Account']"}),
            'created_at': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'default_filetype': ('django.db.models.fields.CharField', [], {'default': "'C'", 'max_length': '255'}),
