...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Donor.account'
        db.add_column('donors_donor', 'account', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['accounts.Account']), keep_default=False)

        # Adding field 'Donation.account'
        db.add_column('donors_donation', 'account', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['accounts.Account']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Donor.account'
        db.delete_column('donors_donor', 'account_id')

        # Deleting field 'Donation.account'
        db.delete_column('donors_donation', 'account_id')
