...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('donors_donation', 'old_id', self.gf('django.db.models.fields.IntegerField')(db_index=True, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Donation.old_id'
        db.delete_column('donors_donation', 'old_id')
