...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'LeftSide.order'
        db.add_column('rules_leftside', 'order', self.gf('django.db.models.fields.IntegerField')(default=100), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'LeftSide.order'
        db.delete_column('rules_leftside', 'order')
