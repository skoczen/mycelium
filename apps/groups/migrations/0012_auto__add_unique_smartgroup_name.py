...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'SmartGroup', fields ['name']
        db.create_unique('groups_smartgroup', ['name'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'SmartGroup', fields ['name']
        db.delete_unique('groups_smartgroup', ['name'])
