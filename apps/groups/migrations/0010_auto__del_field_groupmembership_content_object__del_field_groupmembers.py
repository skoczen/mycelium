...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'GroupMembership.content_object'
        db.delete_column('groups_groupmembership', 'content_object_id')

        # Deleting field 'GroupMembership.tag'
        db.delete_column('groups_groupmembership', 'tag_id')


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'GroupMembership.content_object'
        raise RuntimeError("Cannot reverse this migration. 'GroupMembership.content_object' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'GroupMembership.tag'
        raise RuntimeError("Cannot reverse this migration. 'GroupMembership.tag' and its values cannot be restored.")
