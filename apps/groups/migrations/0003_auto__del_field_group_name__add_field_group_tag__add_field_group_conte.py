...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Group.tag'
        db.add_column('groups_group', 'tag', self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='groups_group_items', to=orm['taggit.Tag']), keep_default=False)

        # Adding field 'Group.content_object'
        db.add_column('groups_group', 'content_object', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['people.Person']), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Group.tag'
        db.delete_column('groups_group', 'tag_id')

        # Deleting field 'Group.content_object'
        db.delete_column('groups_group', 'content_object_id')
