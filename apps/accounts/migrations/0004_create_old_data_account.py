...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        call_command("loaddata", "accounts/initial_data.json")
        monthly_plan = orm["accounts.Plan"].objects.get_or_create(name="Monthly")[0]
        orm.Account.objects.create(plan=monthly_plan, name="Old GoodCloud Test Data", subdomain="oldgoodcloudtest")

    def backwards(self, orm):
        monthly_plan = orm["accounts.Plan"].objects.get_or_create(name="Monthly")[0]
        orm.Account.objects.filter(plan=monthly_plan, name="Old GoodCloud Test Data", subdomain="oldgoodcloudtest").delete()
