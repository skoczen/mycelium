...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Account.has_completed_any_challenges'
        db.add_column('accounts_account', 'has_completed_any_challenges', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Account.has_completed_any_challenges'
        db.delete_column('accounts_account', 'has_completed_any_challenges')
