...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Account.is_demo'
        db.add_column('accounts_account', 'is_demo', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Account.is_demo'
        db.delete_column('accounts_account', 'is_demo')
    ...
    models = {
        ...
        'accounts.account': {
            ...
            'signup_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 7, 19, 22, 24, 19, 354320)', 'null': 'True'}),
