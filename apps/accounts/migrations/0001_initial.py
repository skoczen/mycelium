...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('accounts_account', (
            ...
            ('plan', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['accounts.Plan'])),
        ))
        db.send_create_signal('accounts', ['Account'])

        # Adding model 'AccessLevel'
        db.create_table('accounts_accesslevel', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal('accounts', ['AccessLevel'])

        # Adding model 'UserAccount'
        db.create_table('accounts_useraccount', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('account', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['accounts.Account'])),
            ('access_level', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['accounts.AccessLevel'])),
        ))
        db.send_create_signal('accounts', ['UserAccount'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'AccessLevel'
        db.delete_table('accounts_accesslevel')

        # Deleting model 'UserAccount'
        db.delete_table('accounts_useraccount')
