...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('people_person', 'birth_date', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'Person.birth_month'
        db.add_column('people_person', 'birth_month', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'Person.birth_year'
        db.add_column('people_person', 'birth_year', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'Person.actual_birthday'
        db.add_column('people_person', 'actual_birthday', self.gf('django.db.models.fields.DateField')(null=True, blank=True), keep_default=False)

        # Adding field 'Person.normalized_birthday'
        db.add_column('people_person', 'normalized_birthday', self.gf('django.db.models.fields.DateField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Person.birth_date'
        db.delete_column('people_person', 'birth_date')

        # Deleting field 'Person.birth_month'
        db.delete_column('people_person', 'birth_month')

        # Deleting field 'Person.birth_year'
        db.delete_column('people_person', 'birth_year')

        # Deleting field 'Person.actual_birthday'
        db.delete_column('people_person', 'actual_birthday')

        # Deleting field 'Person.normalized_birthday'
        db.delete_column('people_person', 'normalized_birthday')
    ...
    models = {
        ...
        'people.person': {
            ...
            'birth_date': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
