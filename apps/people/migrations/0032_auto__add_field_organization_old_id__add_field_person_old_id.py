...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Organization.old_id'
        db.add_column('people_organization', 'old_id', self.gf('django.db.models.fields.IntegerField')(db_index=True, null=True, blank=True), keep_default=False)

        # Adding field 'Person.old_id'
        db.add_column('people_person', 'old_id', self.gf('django.db.models.fields.IntegerField')(db_index=True, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Organization.old_id'
        db.delete_column('people_organization', 'old_id')

        # Deleting field 'Person.old_id'
        db.delete_column('people_person', 'old_id')
