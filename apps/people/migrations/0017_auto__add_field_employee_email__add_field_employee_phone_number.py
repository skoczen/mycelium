...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('people_employee', 'email', self.gf('django.db.models.fields.CharField')(default='', max_length=255), keep_default=False)

        # Adding field 'Employee.phone_number'
        db.add_column('people_employee', 'phone_number', self.gf('django.db.models.fields.CharField')(default='', max_length=255), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Employee.email'
        db.delete_column('people_employee', 'email')

        # Deleting field 'Employee.phone_number'
        db.delete_column('people_employee', 'phone_number')
