...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Organization.website'
        db.alter_column('people_organization', 'website', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'Organization.twitter_username'
        db.alter_column('people_organization', 'twitter_username', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'Organization.primary_phone_number'
        db.alter_column('people_organization', 'primary_phone_number', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))


    def backwards(self, orm):
        
        # Changing field 'Organization.website'
        db.alter_column('people_organization', 'website', self.gf('django.db.models.fields.CharField')(default=None, max_length=255))

        # Changing field 'Organization.twitter_username'
        db.alter_column('people_organization', 'twitter_username', self.gf('django.db.models.fields.CharField')(default='', max_length=255))

        # Changing field 'Organization.primary_phone_number'
        db.alter_column('people_organization', 'primary_phone_number', self.gf('django.db.models.fields.CharField')(default='', max_length=255))
