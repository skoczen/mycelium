...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'PeopleAndOrganizationsSearchProxy.group'
        db.delete_column('people_peopleandorganizationssearchproxy', 'group_id')


    def backwards(self, orm):
        
        # Adding field 'PeopleAndOrganizationsSearchProxy.group'
        db.add_column('people_peopleandorganizationssearchproxy', 'group', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['groups.Group'], null=True, blank=True), keep_default=False)
