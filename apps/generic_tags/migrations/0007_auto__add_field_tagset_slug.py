...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'TagSet.slug'
        db.add_column('generic_tags_tagset', 'slug', self.gf('django.db.models.fields.SlugField')(default='', max_length=255, db_index=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'TagSet.slug'
        db.delete_column('generic_tags_tagset', 'slug')
