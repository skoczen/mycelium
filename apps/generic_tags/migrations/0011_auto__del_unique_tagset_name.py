...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing unique constraint on 'TagSet', fields ['name']
        db.delete_unique('generic_tags_tagset', ['name'])


    def backwards(self, orm):
        
        # Adding unique constraint on 'TagSet', fields ['name']
        db.create_unique('generic_tags_tagset', ['name'])
