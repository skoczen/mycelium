...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'DataImport.failed'
        db.add_column('data_import_dataimport', 'failed', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'DataImport.failed'
        db.delete_column('data_import_dataimport', 'failed')
