...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'DataImport'
        db.create_table('data_import_dataimport', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('modified_at', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('account', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['accounts.Account'])),
            ('importer', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['accounts.UserAccount'])),
            ...
            ('import_type', self.gf('django.db.models.fields.IntegerField')()),
            ('num_source_rows', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('spreadsheet', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['data_import.ImportSpreadsheet'])),
        ))
        db.send_create_signal('data_import', ['DataImport'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'DataImport'
        db.delete_table('data_import_dataimport')
    ...
    models = {
        ...
        'data_import.dataimport': {
            ...
            'spreadsheet': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['data_import.ImportSpreadsheet']"}),
            'start_time': ('django.db.models.fields.DateTimeField', [], {'blank': 'True'})
        },
        'data_import.importspreadsheet': {
            'Meta': {'object_name': 'ImportSpreadsheet'},
            'account': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['accounts.Account']"}),
            'columns': ('picklefield.fields.PickledObjectField', [], {'null': 'True', 'blank': 'True'}),
            'created_at': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified_at': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
