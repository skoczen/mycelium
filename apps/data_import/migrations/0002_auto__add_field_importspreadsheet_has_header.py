...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ImportSpreadsheet.has_header'
        db.add_column('data_import_importspreadsheet', 'has_header', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ImportSpreadsheet.has_header'
        db.delete_column('data_import_importspreadsheet', 'has_header')
